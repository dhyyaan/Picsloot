...
import com.think360.picsloot.imagepicker.util.ImageUtil;
import com.think360.picsloot.imagepicker.util.SystemUtil;
import com.think360.picsloot.imagepicker.widget.CheckBox;
import com.think360.picsloot.imagepicker.widget.PickerBottomLayout;
import com.think360.picsloot.imagepicker.widget.PicturePreviewPageView;
import com.think360.picsloot.imagepicker.widget.PreviewViewPager;
import com.think360.picsloot.imagepicker.widget.subsamplingview.ImageSource;
import com.think360.picsloot.imagepicker.widget.subsamplingview.OnImageEventListener;
...
public class PickerPreviewActivity extends BasePickerActivity implements PickerAction {
  ...
  public static void startPicturePreviewFromPicker(Activity activityContext,
      ...
      @StringRes int pickRes, AnchorInfo anchorInfo,
      int requestCode) {
