...
import com.think360.picsloot.imagepickermodified.cache.CacheManager;
import com.think360.picsloot.imagepickermodified.utils.ScaleTypeFillCenterInside;
...
public class FrescoImageLoader implements ImageLoader {
  ...
  private void init() {
    DiskCacheConfig diskCacheConfig =
        DiskCacheConfig
            .newBuilder(AppController.getAppContext())
    ...
    ImagePipelineConfig config =
        OkHttpImagePipelineConfigFactory
            ...
            .build();
    Fresco.initialize(AppController.getAppContext(), config);
  }
