...
import com.think360.picsloot.util.Utils;
...
public class CircularProgressBar extends View {
    ...
    private final int default_finished_color = Color.rgb(198, 34, 57);
    private final int default_unfinished_color = Color.rgb(220, 220, 220);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.CircularProgressBar_arc_finished_color, default_finished_color);
        unfinishedStrokeColor = attributes.getColor(R.styleable.CircularProgressBar_arc_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.CircularProgressBar_arc_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.CircularProgressBar_arc_text_size, default_text_size);
        arcAngle = attributes.getFloat(R.styleable.CircularProgressBar_arc_angle, default_arc_angle);
        setMax(attributes.getInt(R.styleable.CircularProgressBar_arc_max, default_max));
        setProgress(attributes.getInt(R.styleable.CircularProgressBar_arc_progress, 0));
        strokeWidth = attributes.getDimension(R.styleable.CircularProgressBar_arc_stroke_width, default_stroke_width);
        suffixTextSize = attributes.getDimension(R.styleable.CircularProgressBar_arc_suffix_text_size, default_suffix_text_size);
        suffixText = TextUtils.isEmpty(attributes.getString(R.styleable.CircularProgressBar_arc_suffix_text)) ? default_suffix_text : attributes.getString(R.styleable.CircularProgressBar_arc_suffix_text);
        suffixTextPadding = attributes.getDimension(R.styleable.CircularProgressBar_arc_suffix_text_padding, default_suffix_padding);
        bottomTextSize = attributes.getDimension(R.styleable.CircularProgressBar_arc_bottom_text_size, default_bottom_text_size);
        bottomText = attributes.getString(R.styleable.CircularProgressBar_arc_bottom_text);
    }
